export default {
  translation: {
    ...
    project: {
      ...
      predictionResult: 'Project Completion Prediction',
      completionProbability: 'Completion Probability',
      riskLevel: 'Risk Level',
      riskLevelGreen: 'Low Risk',
      riskLevelYellow: 'Medium Risk',
      riskLevelRed: 'High Risk',
      featureSummary: 'Feature Summary',
      daysElapsedRatio: 'Days Elapsed',
      remainingRatio: 'Remaining Work',
      velocityCurrent: 'Current Velocity',
      velocityAvg: 'Average Velocity',
      projectedCompletionRatio: 'Projected Completion',
      blockedStories: 'Blocked Stories',
      attendanceRate: 'Attendance Rate',
      predictedAt: 'Predicted At',
      loadingPrediction: 'Loading prediction data...',
      noPredictionData: 'No prediction data available',
      noActiveSprint: 'This project has no active sprint',
      predictionFailed: 'Failed to fetch prediction data',
    },
